package de.robv.android.xposed.installer.logic.adapters.info
...
import de.robv.android.xposed.installer.logic.adapters.info.viewholders.TabInfoBaseViewHolderHeader
...
class TabInfoBaseAdapter(private val context: Context, private val delegate: TabInfoBaseViewHolder.Delegate): BaseAdapter() {
    ...
    init {
        ...
        for(i in 0..2) {
            addSection(ArrayList<TabInfoModel>())
        }
    }

    fun addItems(section: Int, items: ArrayList<TabInfoModel>) {
