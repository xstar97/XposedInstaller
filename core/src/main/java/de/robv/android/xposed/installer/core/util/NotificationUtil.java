...
public final class NotificationUtil
{
    ...
    public static void init() {
        ...
        sContext = BaseXposedApp.getInstance();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            */
            ...
            if (!rootUtil.startShell()) {
                Log.e(BaseXposedApp.TAG, "Could not start root shell");
                return;
            }
    ...
    public static Intent getActivity() {
        return sContext.getPackageManager().getLaunchIntentForPackage(BASE_PKG);
    }
}
