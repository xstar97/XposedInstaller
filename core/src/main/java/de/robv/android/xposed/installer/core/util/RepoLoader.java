...
import de.robv.android.xposed.installer.core.repo.RepoParser.RepoParserCallback;
import de.robv.android.xposed.installer.core.repo.Repository;
...
public class RepoLoader extends OnlineLoader<RepoLoader>
{
    ...
    private String PREF_KEY_RELEASE_TYPE = "release_type_global";
    private String PREF_VALUE_RELEASE_TYPE = "stable";
    ...
    private RepoLoader() {
        ...
        mGlobalReleaseType = ReleaseType.fromString(BaseXposedApp.getPreferences().getString(PREF_KEY_RELEASE_TYPE, PREF_VALUE_RELEASE_TYPE));
        refreshRepositories();
    }
    ...
    private boolean downloadAndParseFiles(List<String> messages) {
        ...
        for (Entry<Long, Repository> repoEntry : mRepositories.entrySet()) {
            ...
            Log.i(BaseXposedApp.TAG, String.format(
            ...
            try {
                ...
                Log.e(BaseXposedApp.TAG, "Cannot load repository from " + url, t);
