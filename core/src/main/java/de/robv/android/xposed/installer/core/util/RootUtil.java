...
public class RootUtil
{
    ...
    public static class LogLineCallback implements LineCallback {
        @Override
        public void onLine(String line) {
            Log.i(BaseXposedApp.TAG, line);
        }

        @Override
        public void onErrorLine(String line) {
            Log.e(BaseXposedApp.TAG, line);
        }
    }
    ...
    private final OnCommandResultListener mOpenListener = new OnCommandResultListener() {
        @Override
    ...
    private static String getCanonicalPath(File file) {
        try {
            ...
            Log.w(BaseXposedApp.TAG, "Could not get canonical path for " + file);
