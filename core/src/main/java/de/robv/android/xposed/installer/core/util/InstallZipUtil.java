...
public final class InstallZipUtil {
    ...
    public static ZipCheckResult checkZip(ZipFile zip) {
        ...
        if (xposedPropEntry != null) {
            try {
                ...
                Log.e(BaseXposedApp.TAG, "Failed to read system/xposed.prop from " + zip.getName(), e);
            }
        }
    ...
    public static String messageForError(int code, Object... args) {
        Context context = BaseXposedApp.getInstance();
        switch (code) {
    ...
    public static void reportMissingFeatures(Set<String> missingFeatures) {
        Log.e(BaseXposedApp.TAG, "Installer version: " + BuildConfig.VERSION_NAME);
        Log.e(BaseXposedApp.TAG, "Missing installer features: " + missingFeatures);
    }
